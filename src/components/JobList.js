...
const JobList = () => {
  ...
  const experienceItems = {
    "Smart Choice Pharamacy": {
      jobTitle: "IT Intern @",
      duration: "April 2020 - August 2020",
      desc: [
        "Designed database schemas and ensuring their stability, reliability, and performance.",
        "Collaborated and consulted with experienced cross-disciplinary mentors to conceive and build data records.",
        "Assisted with troubleshooting issues and provided technical support."
      ]
    }
